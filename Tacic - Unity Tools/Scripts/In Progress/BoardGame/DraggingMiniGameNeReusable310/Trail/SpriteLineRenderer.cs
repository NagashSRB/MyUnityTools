...
namespace WebelinxGames.RoomsAndExits.Level310
{
    ...
    public class SpriteLineRenderer : MonoBehaviour
    {
        ...
        public void Initialize(Transform startingLinePoint, Transform endLinePoint, float drawingOffset = 0f)
        {
            SetUpPoints(startingLinePoint, endLinePoint, drawingOffset);
        ...
        public void SetUpPoints(Transform startingLinePoint, Transform endLinePoint, float drawingOffset = 0f)
        {
            startPoint = startingLinePoint;
            endPoint = endLinePoint;
            //drawOffset = drawingOffset;
            drawOffset = (spriteRenderer.sprite.rect.height / spriteRenderer.sprite.pixelsPerUnit) / 2;
        }
        ...
        public void DrawLine()
        {
            ...
            Vector2 beginEndVector = endPoint.position - startPoint.position;
            //Vector2 lineBeginPosition = startPoint.position;
            Vector2 lineBeginPosition = (Vector2) startPoint.position - drawOffset * beginEndVector.normalized;
            //Vector2 lineEndPosition = endPoint.position;
            Vector2 lineEndPosition = (Vector2) endPoint.position + drawOffset * beginEndVector.normalized;
